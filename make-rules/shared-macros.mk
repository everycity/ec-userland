...
LDFLAGS_LIBPATH.32 = -L$(USRDIR)/lib -R$(USRDIR)/lib
LDFLAGS_LIBPATH.64 = -L$(USRDIR)/lib/$(MACH64) -R$(USRDIR)/lib/$(MACH64)
LDFLAGS_LIBPATH = $(LDFLAGS_LIBPATH.$(BITS))
LDFLAGS = $(LDFLAGS_LIBPATH)

SYSCONFDIR = $(ECPREFIX)/etc
CONFIGURE_SYSCONFDIR = $(SYSCONFDIR)
LOCALSTATEDIR = $(ECPREFIX)/var
...
USRBINDIR64 =		$(USRBINDIR)/$(MACH64)
USRLIBDIR64 =		$(USRLIBDIR)/$(MACH64)
PROTOBINDIR =		$(PROTO_DIR)$(BINDIR)
PROTOETCDIR =		$(PROTO_DIR)$(ETCDIR)
PROTOETCSECDIR = 	$(PROTOETCDIR)/security
...
PYTHON.2.7.32 =	$(USRBINDIR)/python2.7
PYTHON.2.7.64 =	$(USRBINDIR)/$(MACH64)/python2.7

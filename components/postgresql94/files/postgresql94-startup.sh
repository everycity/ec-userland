...
# via SMF using "svccfg -s postgresql94:default" and setprop


bin_dir="/ec/lib/postgres/9.4/bin"
data_dir="/ec/var/postgres/9.4/data"
config_file="/ec/etc/postgres/9.4/postgresql.conf"

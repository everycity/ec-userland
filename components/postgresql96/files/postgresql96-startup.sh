...
# via SMF using "svccfg -s postgresql95:default" and setprop


bin_dir="/ec/lib/postgres/9.6/bin"
data_dir="/ec/var/postgres/9.6/data"
config_file="/ec/etc/postgres/9.6/postgresql.conf"

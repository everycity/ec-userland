...
# via SMF using "svccfg -s mariadb55:default" and setprop

config_file="/ec/etc/mariadb/5.5/my.cnf"
user="mariadb"
data_dir="/ec/var/mariadb/5.5/data"
unix_socket_file="/tmp/mariadb.sock"
tcp_listen_address="127.0.0.1"
tcp_listen_port="3306"
error_log="/ec/var/mariadb/5.5/data/mariadbd.log"
pid_file="/ec/var/mariadb/5.5/data/mariadbd.pid"
mariadbd_32_binary="/ec/lib/mariadb/5.5/bin/mariadbd"
mariadbd_64_binary="/ec/lib/mariadb/5.5/bin/amd64/mariadbd"
mariadbd_installdb_binary="/ec/lib/mariadb/5.5/bin/mariadb_install_db"

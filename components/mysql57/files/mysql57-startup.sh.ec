...
# via SMF using "svccfg -s mysql57:default" and setprop

config_file="/ec/etc/mysql/5.7/my.cnf"
user="mysql"
data_dir="/ec/var/mysql/5.7/data"
unix_socket_file="/tmp/mysql.sock"
tcp_listen_address="127.0.0.1"
tcp_listen_port="3306"
error_log="/ec/var/mysql/5.7/data/mysqld.log"
pid_file="/ec/var/mysql/5.7/data/mysqld.pid"
mysqld_32_binary="/ec/lib/mysql/5.7/bin/mysqld"
mysqld_64_binary="/ec/lib/mysql/5.7/bin/amd64/mysqld"
mysqld_installdb_binary="/ec/lib/mysql/5.7/bin/mysql_install_db"

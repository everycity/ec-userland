...
# via SMF using "svccfg -s postgresql91:default" and setprop


bin_dir="/ec/lib/postgres/9.1/bin"
data_dir="/ec/var/postgres/9.1/data"
config_file="/ec/etc/postgres/9.1/postgresql.conf"
